...
{
    public class BaseReposiroies<TEntity> : IBaseRepositories<TEntity> where TEntity : class
    {
        ...
        public BaseReposiroies(IDbContext dbContext)
        {
        ...
        public async Task<bool> DeleteObjAsync(TEntity entity)
        {
            try
            {
                if (entity != null)
